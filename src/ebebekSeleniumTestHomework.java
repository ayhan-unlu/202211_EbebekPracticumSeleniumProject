...
public class ebebekSeleniumTestHomework {
    public static void main(String[] args) throws Exception {
     ...
     // driver.get("https://www.e-bebek.com");//to indicate where you want to go https:// must be included not obligatory to assign a variable like baseUrl
        ...
        driver.findElement(By.id("txtSearchBox")).sendKeys("biberon",Keys.ENTER);//finds the id for search bar and enters biberon-Baby bottle word for searching
        ...
        //xpath is not working properly throws "no such element" error
       ...
       // Thread.sleep(10000);//waits for 1 second to go to next line of code
        ...
        Thread.sleep(10000);//waits for 10 second to go to next line of code
